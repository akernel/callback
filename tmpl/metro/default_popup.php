...
<a class="show_callback <?=$params->get('button_sfc_class')?>" data-moduleid="<?=$module->id?>" data-animationspeed="<?=$params->get('animation_speed')?>" data-animation="<?=$params->get('show_animate')?>" href="javascript:void(0)" title="<?php echo JText::_('modcallback_open') ?>"><?php echo $params->get('button_text')?></a>
<?php elseif($params->get('button_type') == 2): ?>
<a class="show_callback jCallbackBttn <?=$params->get('button_sfc_class')?>" data-moduleid="<?=$module->id?>" data-animationspeed="<?=$params->get('animation_speed')?>" data-animation="<?=$params->get('show_animate')?>" href="javascript:void(0)" title="<?php echo JText::_('modcallback_open') ?>"><?php echo $params->get('button_text')?></a>
<?php elseif($params->get('button_type') == 3): ?>
<a class="show_callback jCallbackBttnOnDown<?php echo($params->get('button_position')==2 ? ' left' : '');?> <?=$params->get('button_sfc_class')?>" data-moduleid="<?=$module->id?>" data-animationspeed="<?=$params->get('animation_speed')?>" data-animation="<?=$params->get('show_animate')?>" href="javascript:void(0)" title="<?php echo JText::_('modcallback_open') ?>"><?php echo $params->get('button_text')?></a>
<?php endif; ?>
<div id="jCallBack-<?=$module->id?>" class="jCallBack-popup<?php echo($params->get('show_animate') != 'jQ' ? ' animated forwards' : '');?>" data-animationspeed="<?=$params->get('animation_speed')?>" data-animation="<?=$params->get('show_animate')?>">
    <div class="jCallBack-content">
        <?php if($params->get('show_title')): ?>
		<center><div id="form_title"><span><?php echo $params->get('title')?></span></div></center>
        <?php endif; ?>
		<div class="form_item">
